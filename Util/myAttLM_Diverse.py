...
from myAttWrapper import SelfAttWrapper
...
class LM:
    def __init__(self, dp, rnn_size, n_layers, decoder_embedding_dim, max_infer_length, is_jieba, gamma,
    ...
    def add_input_layer(self):
        self.X = tf.placeholder(tf.int32, [1, None], name="X")
        self.X_seq_len = tf.placeholder(tf.int32, [1], name="X_seq_len")
    ...
    def rollout_batch(self, input_indices):
        ...
        input_indices = [x.tolist()+[self.dp.X_w2id['<EOS>'],] for x in input_indices]
        #print(input_indices)
