...
from myAttWrapper import SelfAttMulOtWrapper
...
class LM:
    ...
    def add_decoder_for_training(self):
        ...
        self.decoder_cell = SelfAttMulOtWrapper(self.decoder_cell, self.init_memory, 
    ...
    def add_decoder_for_prefix_inference(self):
        ...
        self.decoder_cell = SelfAttMulOtWrapper(self.decoder_cell, 
